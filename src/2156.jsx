...
export default function ParcelLabelSim() {
  ...
  useEffect(() => {
    ...
    const sourceSign = makeTextPlane("ITEMS TO BE PACKED", C.blue, 3.8, 0.5);
    ...
    stagingTables.forEach((cfg) => {
      ...
      tableSign.position.set(cx, 1.75, cz);
  ...
  const setView = (name) => {
    ...
    const views = {
      ...
      "Waiting Area": { target: [-3.8, 0.8, 2.8], theta: -0.55, phi: 0.95, radius: 17 },
